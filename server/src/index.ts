...
import { HealthCheckResponse, ListToDoRequest, ListToDoResponse } from './protos/todo_pb';
...
const healthCheck = (_call: grpc.ServerUnaryCall<void, HealthCheckResponse>, callback: grpc.sendUnaryData<HealthCheckResponse>) => {
    const response = new HealthCheckResponse()
    .setLive(new HealthCheckResponse.HealthCheck()
    .setCpu(90)
    .setDb(true)
    .setMemory(80)
...
const listToDo = (_call: grpc.ServerUnaryCall<ListToDoRequest, ListToDoResponse>, callback: grpc.sendUnaryData<ListToDoResponse>) => {
